...
public class MybatisConfigAccess extends AbstractConfigAccess {
    ...
    public List<GroupConfig> getAllOpenGroupConfig() {
        return getAllConfigGroupList().stream().filter(i -> StatusEnum.YES.getStatus().equals(i.getGroupStatus()))
    ...
    public Set<String> getBlacklist(String groupName) {
        ...
        LambdaQueryWrapper<SceneConfig> sceneConfigLambdaQueryWrapper =
            new LambdaQueryWrapper<SceneConfig>().eq(SceneConfig::getSceneName, groupName);
    ...
    public List<GroupConfig> getAllConfigGroupList() {
        List<GroupConfig> allSystemConfigGroupList =
            groupConfigMapper.selectList(new LambdaQueryWrapper<GroupConfig>().orderByAsc(GroupConfig::getId));
