...
public class RpcClientInvokeHandler implements InvocationHandler {
    ...
    public RpcClientInvokeHandler(final String groupName, final String hostId, final String hostIp,
        final Integer hostPort, final String contextPath) {
        ...
        try {
            ...
            if (ex instanceof ResourceAccessException) {
                ...
                ClientNodeAllocateHandler clientNodeAllocateHandler =
                    SpringContext.CONTEXT.getBean(ClientNodeAllocateHandler.class);
