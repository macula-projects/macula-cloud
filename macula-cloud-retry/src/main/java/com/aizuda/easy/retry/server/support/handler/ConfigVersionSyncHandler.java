...
public class ConfigVersionSyncHandler implements Lifecycle, Runnable {
    ...
    private static final LinkedBlockingQueue<Pair<String/*groupName*/, Integer/*版本号*/>> QUEUE =
    ...
    public void syncVersion(String groupName) {
        ...
        try {
            ...
            for (final RegisterNodeInfo registerNodeInfo : serverNodeSet) {
                ...
                String format =
                    MessageFormat.format(URL, registerNodeInfo.getHostIp(), registerNodeInfo.getHostPort().toString(),
