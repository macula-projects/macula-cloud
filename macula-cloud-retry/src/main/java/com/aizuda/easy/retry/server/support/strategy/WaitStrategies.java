...
public class WaitStrategies {
    ...
    public enum WaitStrategyEnum {
        DELAY_LEVEL(1, delayLevelWait()), FIXED(2, fixedWait()), CRON(3, cronWait()), RANDOM(4, randomWait());
     ...
     */
    public static WaitStrategy randomWait(long minimumTime, TimeUnit minimumTimeUnit, long maximumTime,
    ...
    private static final class FixedWaitStrategy implements WaitStrategy {
        ...
        public LocalDateTime computeRetryTime(RetryContext retryContext) {
            ...
            if (TaskTypeEnum.CALLBACK.getType().equals(retryTask.getTaskType())) {
                ...
                SceneConfig sceneConfig = configAccess.getSceneConfigByGroupNameAndSceneName(retryTask.getGroupName(),
    ...
    private static final class CronWaitStrategy implements WaitStrategy {
        ...
        public LocalDateTime computeRetryTime(RetryContext context) {
            ...
            try {
                ...
                nextValidTime = new CronExpression(sceneConfig.getTriggerInterval()).getNextValidTimeAfter(
