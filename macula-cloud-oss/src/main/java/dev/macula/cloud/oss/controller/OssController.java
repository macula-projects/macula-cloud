...
public class OssController {
    ...
    /**
     * http://localhost:8080/upload http://localhost:8080/upload?platform=test-minio
     * http://localhost:8080/upload?platform=minio3 http://localhost:8080/upload?platform=aliyunOss
     */
    @GetMapping("upload")
