...
public class AuthController {
    ...
    public Result<AuthService.AuthUser> login(HttpServletRequest request, String username, String password) {
        if (StrUtil.isNotBlank(DashboardConfig.getAuthUsername())) {
            authUsername = DashboardConfig.getAuthUsername();
        }

        if (StrUtil.isNotBlank(DashboardConfig.getAuthPassword())) {
         ...
         */
        if (StrUtil.isNotBlank(authUsername) && !authUsername.equals(username) || StrUtil.isNotBlank(
            authPassword) && !authPassword.equals(password)) {
