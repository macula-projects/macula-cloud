...
@Import(
    {NoAuthConfigurationTest.class, InMemGatewayFlowRuleStore.class, AppManagement.class, SimpleMachineDiscovery.class})
public class GatewayFlowRuleControllerTest {
    ...
    public void testQueryFlowRules() throws Exception {
        ...
        Result<List<GatewayFlowRuleEntity>> result =
            JSONObject.parseObject(mvcResult.getResponse().getContentAsString(),
                new TypeReference<Result<List<GatewayFlowRuleEntity>>>() {
                });
    ...
    public void testDeleteFlowRule() throws Exception {
        ...
        // Verify the result
        Result<Long> result =
            JSONObject.parseObject(mvcResult.getResponse().getContentAsString(), new TypeReference<Result<Long>>() {
            });
        assertTrue(result.isSuccess());
