...
public class BranchSessionVO {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(xid, that.xid) && Objects.equals(transactionId, that.transactionId) && Objects.equals(
            branchId, that.branchId) && Objects.equals(resourceGroupId, that.resourceGroupId) && Objects.equals(
            resourceId, that.resourceId) && Objects.equals(branchType, that.branchType) && Objects.equals(status,
            that.status) && Objects.equals(clientId, that.clientId) && Objects.equals(applicationData,
            that.applicationData) && Objects.equals(gmtCreate, that.gmtCreate) && Objects.equals(gmtModified,
            that.gmtModified);
    }
    ...
    public String toString() {
        return "BranchSessionVO{" + "xid='" + xid + '\'' + ", transactionId=" + transactionId + ", branchId=" + branchId + ", resourceGroupId='" + resourceGroupId + '\'' + ", resourceId='" + resourceId + '\'' + ", branchType='" + branchType + '\'' + ", status=" + status + ", clientId='" + clientId + '\'' + ", applicationData='" + applicationData + '\'' + ", gmtCreate=" + gmtCreate + ", gmtModified=" + gmtModified + '}';
    }
}
