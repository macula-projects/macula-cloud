...
public abstract class AbstractCore implements Core {
    ...
    public Long branchRegister(BranchType branchType, String resourceId, String clientId, String xid,
        ...
        return SessionHolder.lockAndExecute(globalSession, () -> {
            ...
            BranchSession branchSession =
                SessionHelper.newBranchByGlobal(globalSession, branchType, resourceId, applicationData, lockKeys,
                    clientId);
    ...
    protected BranchStatus branchCommitSend(BranchCommitRequest request, GlobalSession globalSession,
        ...
        BranchCommitResponse response =
            (BranchCommitResponse)remotingServer.sendSyncRequest(branchSession.getResourceId(),
                branchSession.getClientId(), request, branchSession.isAT());
    ...
    protected BranchStatus branchRollbackSend(BranchRollbackRequest request, GlobalSession globalSession,
        ...
        BranchRollbackResponse response =
            (BranchRollbackResponse)remotingServer.sendSyncRequest(branchSession.getResourceId(),
                branchSession.getClientId(), request, branchSession.isAT());
        return response.getBranchStatus();
    }
