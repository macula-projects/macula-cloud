...
public class SeataPropertiesLoader implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    List<String> prefixList =
        Arrays.asList(FILE_ROOT_PREFIX_CONFIG, FILE_ROOT_PREFIX_REGISTRY, SERVER_PREFIX, STORE_PREFIX, METRICS_PREFIX,
            TRANSPORT_PREFIX);
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        if (CollectionUtils.isNotEmpty(configs)) {
            ...
            originFileInstance.ifPresent(
                fileConfiguration -> configs.putAll(fileConfiguration.getFileConfig().getAllConfig()));
