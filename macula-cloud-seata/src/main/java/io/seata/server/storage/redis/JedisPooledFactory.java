                    ...
                    if (jedisPools != null && jedisPools.length > 0) {
                        ...
                        if (mode.equals(ConfigurationKeys.REDIS_SENTINEL_MODE)) {
                            ...
                            String[] sentinelHosts =
                                CONFIGURATION.getConfig(ConfigurationKeys.STORE_REDIS_SENTINEL_HOST).split(",");
                            ...
                            host =
                                StringUtils.isBlank(host) ? CONFIGURATION.getConfig(ConfigurationKeys.STORE_REDIS_HOST,
                                    HOST) : host;
