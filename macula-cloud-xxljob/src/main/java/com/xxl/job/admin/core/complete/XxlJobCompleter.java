...
public class XxlJobCompleter {
    ...
    private static void finishJob(XxlJobLog xxlJobLog) {
        ...
        if (XxlJobContext.HANDLE_CODE_SUCCESS == xxlJobLog.getHandleCode()) {
            ...
            if (xxlJobInfo != null && xxlJobInfo.getChildJobId() != null && xxlJobInfo.getChildJobId().trim()
                .length() > 0) {
                ...
                for (int i = 0; i < childJobIds.length; i++) {
                    ...
                    if (childJobId > 0) {
                        ...
                        // add msg
                        triggerChildMsg +=
                            MessageFormat.format(I18nUtil.getString("jobconf_callback_child_msg1"), (i + 1),
                        ...
                        triggerChildMsg +=
                            MessageFormat.format(I18nUtil.getString("jobconf_callback_child_msg2"), (i + 1),
                                childJobIds.length, childJobIds[i]);
                    }
                }
