...
public interface MenuTenantConverter {

    MenuVO entity2VO(SysMenuTenant entity);
    ...
    SysMenuTenant MenuDTO2Entity(MenuDTO dto);
    ...
    @Mappings({
            ...
            @Mapping(target = "meta.visible", expression = "java(toBool(sysMenuTenant.getVisible()))"),
            @Mapping(target = "meta.fullpage", expression = "java(toBool(sysMenuTenant.getFullPage()))")
    })
    MenuBO entity2BO(SysMenuTenant sysMenuTenant);
