...
import dev.macula.cloud.iam.grant.base.OAuth2ResourceOwnerBaseAuthenticationProvider;
...
/**
 * {@code OAuth2ResourceOwnerPasswordAuthenticationProvider} 处理用户名密码授权
 *
 * @author jumuning
 * @since 2023-04-18
 */
public class OAuth2ResourceOwnerPasswordAuthenticationProvider
     ...
     *
     * @param authenticationManager 认证Manager
