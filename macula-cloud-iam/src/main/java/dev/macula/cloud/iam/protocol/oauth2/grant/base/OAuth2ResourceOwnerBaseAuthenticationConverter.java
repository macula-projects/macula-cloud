...
public abstract class OAuth2ResourceOwnerBaseAuthenticationConverter<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
     ...
     * 构建具体类型的token
     *
     * @param clientPrincipal      客户端验证凭据
     * @param requestedScopes      请求的SCOPE
     * @param additionalParameters 请求的附加参数
     * @return OAuth2ResourceOwnerBaseAuthenticationToken
     */
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        // 扩展信息
        Map<String, Object> additionalParameters = parameters.entrySet().stream().filter(
                e -> !e.getKey().equals(OAuth2ParameterNames.GRANT_TYPE) && !e.getKey().equals(OAuth2ParameterNames.SCOPE))
