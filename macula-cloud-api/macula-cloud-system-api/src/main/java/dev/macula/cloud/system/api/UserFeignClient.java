...
import dev.macula.cloud.system.api.fallback.UserFeignFallbackClient;
import dev.macula.cloud.system.dto.UserAuthInfo;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(value = "macula-cloud-system", contextId = "userFeignClient", fallback = UserFeignFallbackClient.class)
