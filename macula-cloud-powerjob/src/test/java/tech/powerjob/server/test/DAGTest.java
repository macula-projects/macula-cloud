...
public class DAGTest {
    ...
    public void testListReadyNodes1() {
        ...
        List<Long> readyNodeIds1 = WorkflowDAGUtils.listReadyNodes(dag1).stream().map(PEWorkflowDAG.Node::getNodeId)
    ...
    public void testListReadyNodes2() {
        ...
        List<Long> readyNodeIds2 = WorkflowDAGUtils.listReadyNodes(dag).stream().map(PEWorkflowDAG.Node::getNodeId)
            .collect(Collectors.toList());
