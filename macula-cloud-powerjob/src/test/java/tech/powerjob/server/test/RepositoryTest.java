...
public class RepositoryTest {
    ...
    public void testSelectCronJobSQL() {
        List<JobInfoDO> result =
            jobInfoRepository.findByAppIdInAndStatusAndTimeExpressionTypeAndNextTriggerTimeLessThanEqual(
                Lists.newArrayList(1L), SwitchableStatus.ENABLE.getV(), TimeExpressionType.CRON.getV(),
    ...
    public void testExecuteLogUpdate() {
        instanceInfoRepository.update4TriggerFailed(1586310414570L, 2, System.currentTimeMillis(),
            System.currentTimeMillis(), "192.168.1.1", "NULL", new Date());
    ...
    public void testCheckQuery() {
        ...
        final List<BriefInstanceInfo> res =
            instanceInfoRepository.selectBriefInfoByAppIdInAndStatusAndGmtModifiedBefore(Lists.newArrayList(1L), 3,
                time, PageRequest.of(0, 100));
        System.out.println(res);
    }

    @Test
    public void testFindByJobIdInAndStatusIn() {
        List<Long> res = instanceInfoRepository.findByJobIdInAndStatusIn(Lists.newArrayList(1L, 2L, 3L, 4L),
    ...
    public void testDeleteWorkflowInstanceInfo() {
        workflowInstanceInfoRepository.deleteAllByGmtModifiedBeforeAndStatusIn(new Date(),
            WorkflowInstanceStatus.FINISHED_STATUS);
    }
