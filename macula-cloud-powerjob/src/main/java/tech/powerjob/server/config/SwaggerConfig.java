...
/**
 * Configuration class for Swagger UI. migrate to <a href="https://springdoc.org/">springdoc</a> from v4.3.1
...
public class SwaggerConfig {
    ...
    public OpenAPI springShopOpenAPI() {
        ...
        return new OpenAPI().info(
            new Info().title("PowerJob").description("Distributed scheduling and computing framework.")
                .version(serverInfoService.fetchServiceInfo().getVersion()).contact(contact).license(
                    new License().name("Apache License 2.0")
                        .url("https://github.com/PowerJob/PowerJob/blob/master/LICENSE")));
    }
