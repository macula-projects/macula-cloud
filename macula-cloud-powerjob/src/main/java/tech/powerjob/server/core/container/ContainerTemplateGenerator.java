...
public class ContainerTemplateGenerator {
     ...
     */
    public static File generate(String group, String artifact, String name, String packageName, Integer javaVersion)
        throws IOException {
        ...
        try (InputStream is = ContainerTemplateGenerator.class.getClassLoader()
            .getResourceAsStream(ORIGIN_FILE_NAME + ".zip")) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(pomPath))) {
            while ((line = br.readLine()) != null) {
                ...
                if (line.contains("<groupId>groupId</groupId>")) {
                    ...
                    buffer.append("        <maven.compiler.source>").append(javaVersion)
                        .append("</maven.compiler.source>");
                } else if (line.contains("<maven.compiler.target>")) {
                    buffer.append("        <maven.compiler.target>").append(javaVersion)
