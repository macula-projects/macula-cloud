...
public class CleanService {
    ...
    public CleanService(GridFsManager gridFsManager, InstanceInfoRepository instanceInfoRepository,
    ...
    public void cleanWorkflowInstanceLog() {
        ...
        try {
            Date t = DateUtils.addDays(new Date(), -instanceInfoRetentionDay);
            int num = workflowInstanceInfoRepository.deleteAllByGmtModifiedBeforeAndStatusIn(t,
    ...
    public void cleanWorkflowNodeInfo() {
        try {
            ...
            log.info("[CleanService] deleted {} node records whose create time before {} and workflowId is null.", num,
                t);
        } catch (Exception e) {
